...
# Use hosttech_dns_record_facts module to retrieve the details for new.foo.com
...
# Delete new.foo.com A record using the results from the facts retrieval command
- hosttech_dns_record:
      state: absent
      zone: foo.com
